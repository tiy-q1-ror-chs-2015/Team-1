class StudentSchoolsController < ApplicationController
  ...
  before_action :set_student_school, only: [:show, :edit, :update, :destroy]
  before_action :set_school, only: [:show, :edit, :update, :destroy]
  before_action :set_new_student_school, only: [:new, :create]
  ...
  def set_student_school
    @student_school = Goalpath.find params[:id]
  end

  def set_new_student_school
    @student_school = @student.student_schools.new
  end
